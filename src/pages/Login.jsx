        ...
        <div className='flex bg-black items-center justify-center py-16'>
            <div className="container flex items-center justify-center py-4">
                <div className='w-4/5 flex items-center justify-between gap-28'>
                    <div className='w-1/2'>
                        <h3 className='text-2xl text-white/80 mb-8'>Please login to continue</h3>
                        <form action="" className='flex flex-col gap-2'>
                            <label htmlFor='email' className='text-white/70'>Email</label>
                            <input type="email" name="email" id="email" placeholder='example@email.com' className='border-white/20 text-white border placeholder:text-offwhite/40 p-3 rounded-xl outline-none bg-transparent' />
                            <label htmlFor="password" className='text-white/70 mt-4'>Password</label>
                            <input type="password" name="password" id="password" placeholder='*********' className='border-white/20 text-white border placeholder:text-offwhite/40 p-3 rounded-xl outline-none bg-transparent' />
                            <Link to="/forget" className='text-white/40 text-base mt-4 ml-auto hover:underline transition-all duration-200 underline-offset-2'>Forget password</Link>
                            <input type="button" value="Login" className='mt-8 bg-white p-3 rounded-xl text-xl font-medium' />
                        </form>
